...
namespace Library.ServiceTool.Util
{
    public static class TaskUtility
    {
        ...
        public static void Await(this Func<Task> taskFactory, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (taskFactory == null)
        ...
        public static void Await(this Task task, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (task == null)
        ...
        public static T Await<T>(this Func<Task<T>> taskFactory, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (taskFactory == null)
                throw new ArgumentNullException(nameof(taskFactory));
